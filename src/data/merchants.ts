...
export const MERCHANTS: Merchant[] = [
  // =========================================================================
  // 🌟 全台通用類別（涵蓋所有未列入獨立名冊之實體餐廳、海外消費與一般消費）
  // =========================================================================
  {
    id: 'general-dining',
    name: '全台實體餐飲 (全台各獨立餐廳 / 火鍋 / 燒肉 / 咖啡廳 / 熟度等)',
    category: 'dining_delivery',
    categoryLabel: '外送 & 餐飲',
    tags: ['全台餐飲', '餐廳', '火鍋', '熟度', '牛排', '燒肉', '咖啡', '甜點', '小吃', '居酒屋', '酒吧', '義大利麵', '早午餐', '食堂', '美食'],
    validUntil: '2026/12/31',
    lastVerifiedAt: '2026/08/29',
    officialSourceUrl: CATHAY_OFFICIAL_URL,
    cube: {
      scheme: 'dining',
      schemeName: '樂饗購 (全台餐飲 3.3%)',
      rate: 3.3,
      note: '全台所有登記為餐飲業（MCC 5811~5814）之獨立餐廳/咖啡/火鍋，切換「樂饗購」享 3.0%~3.3% 小樹點！'
    },
    richart: {
      scheme: 'dining',
      schemeName: '好饗刷 (全臺餐飲 3.3%)',
      rate: 3.3,
      note: '全台所有實體餐飲店家（不含餐券），切換「好饗刷」享 3.3% 台新 Point！'
    },
    tips: '只要是台灣營業登記為餐飲業的獨立店家（如熟度火鍋、獨立咖啡店、燒肉居酒屋等），門市直刷切換 CUBE 卡【樂饗購 3.3%】或 Richart 卡【好饗刷 3.3%】均享最高 3.3% 點數回饋！'
  },
  {
    id: 'general-overseas',
    name: '全通路海外消費 (海外實體刷卡 / 跨境線上外幣交易)',
    category: 'travel_traffic',
    categoryLabel: '旅遊 & 交通',
    tags: ['海外消費', '國外刷卡', '外幣交易', '出國旅遊', '日幣', '美金', '歐元', '跨境網購'],
    validUntil: '2026/12/31',
    lastVerifiedAt: '2026/08/29',
    officialSourceUrl: CATHAY_OFFICIAL_URL,
    cube: {
      scheme: 'travel',
      schemeName: '趣旅行 (海外消費 3.3%)',
      rate: 3.3,
      note: '海外實體店家刷卡或外幣線上交易，切換「趣旅行」享 3.0%~3.3% 小樹點！'
    },
    richart: {
      scheme: 'travel',
      schemeName: '玩旅刷 (海外消費 3.3%)',
      rate: 3.3,
      note: '海外消費（含實體、線上及歐洲國家交易），切換「玩旅刷」享 3.3% 台新 Point！'
    },
    tips: '海外實體刷卡或線上外幣消費，切換 CUBE 卡【趣旅行 3.3%】或 Richart 卡【玩旅刷 3.3%】均享 3.3% 回饋（扣除 1.5% 國外手續費後實拿約 1.8%）。'
  },
  {
    id: 'general-spend',
    name: '全通路一般消費 (非特約加碼店家 / 雜項開銷)',
    category: 'general',
    categoryLabel: '一般消費',
    tags: ['一般消費', '雜項', '非特店', '診所', '五金', '水電', '修理', '無加碼'],
    validUntil: '2026/12/31',
    lastVerifiedAt: '2026/08/29',
    ...
    tips: '非特約加碼店家之一般消費：週末六日刷【台新 Richart 卡】切換【假日刷】享 2.0% 台新 Point，平日刷 Richart 卡享 1.0%，均優於 CUBE 的 0.3%！'
  },
